...
class CaptionGeneratorView(views.APIView):
    def post(self, request):
        ...
        def generate_instagram_caption(image_description):
            prompt = f"You are a marketer and copywritter in a selling company, you have to generate a selling script for advertising post. This is the description of used Image in the post: {image_description}, u can leave the price empty also mention a discount of 50%. Give me the script"
            load_dotenv()
